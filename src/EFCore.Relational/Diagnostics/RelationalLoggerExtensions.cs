...
namespace Microsoft.EntityFrameworkCore.Diagnostics
{
    ...
    public static class RelationalLoggerExtensions
    {
        ...
        /// <param name="exception"> The exception that caused this failure. </param>
        public static void LogBatchExecutorFailedToRollbackToSavepoint(
            [NotNull] this IDiagnosticsLogger<DbLoggerCategory.Update> diagnostics,
            [NotNull] Type contextType,
            [NotNull] Exception exception)
        {
            var definition = RelationalResources.BatchExecutorFailedToRollbackToSavepoint(diagnostics);
        ...
        /// <param name="contextType"> The <see cref="DbContext" /> type being used. </param>
        /// <param name="exception"> The exception that caused this failure. </param>
        public static void LogBatchExecutorFailedToReleaseSavepoint(
            [NotNull] this IDiagnosticsLogger<DbLoggerCategory.Update> diagnostics,
            [NotNull] Type contextType,
            [NotNull] Exception exception)
        {
            var definition = RelationalResources.BatchExecutorFailedToReleaseSavepoint(diagnostics);
