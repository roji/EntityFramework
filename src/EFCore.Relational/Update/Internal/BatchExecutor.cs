            ...
            IRelationalConnection connection)
        {
            ...
            catch
            {
                if (createdSavepoint && connection.DbConnection.State == ConnectionState.Open)
                {
                    ...
                    {
                        UpdateLogger.LogBatchExecutorFailedToRollbackToSavepoint(CurrentContext.GetType(), e);
                    }
                }
                ...
                else
                {
                    if (createdSavepoint)
                    {
                        if (connection.DbConnection.State == ConnectionState.Open)
                        {
                            ...
                            {
                                UpdateLogger.LogBatchExecutorFailedToReleaseSavepoint(CurrentContext.GetType(), e);
                            }
                        }
                    }
